...
try:
    ...
    if not _import_logged:
        logger.debug("transformer_model.py: Successfully imported logger from oanda_trading_bot.training_system.common.logger_setup.")
except ImportError:
    ...
    if not _import_logged:
        logger.warning("transformer_model.py: Failed to import logger from oanda_trading_bot.training_system.common.logger_setup. Using fallback logger.")
