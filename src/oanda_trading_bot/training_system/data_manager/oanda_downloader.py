...
try:
    ...
    try:
        ...
        from oanda_trading_bot.training_system.common.logger_setup import logger # 使用 src.common
        from oanda_trading_bot.training_system.data_manager.database_manager import ( # 使用 src.data_manager
