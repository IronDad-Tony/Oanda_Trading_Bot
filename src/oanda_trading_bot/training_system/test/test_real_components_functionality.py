...
def test_volatility_analyzer():
    ...
    try:
        from oanda_trading_bot.training_system.environment.dynamic_reweighting import VolatilityAnalyzer
...
def test_dynamic_reward_normalizer():
    ...
    try:
        from oanda_trading_bot.training_system.environment.reward_normalizer import DynamicRewardNormalizer
...
def test_risk_indicator_monitoring_accuracy():
    ...
    try:
        from oanda_trading_bot.training_system.agent.risk_management_system import MarketStateAwareness
...
def test_stress_test_scenario_coverage():
    ...
    try:
        from oanda_trading_bot.training_system.agent.risk_management_system import StressTester
