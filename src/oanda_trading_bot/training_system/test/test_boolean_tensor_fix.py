...
def test_emergency_stop_loss_boolean_tensor_error():
    ...
    try:
        from oanda_trading_bot.training_system.agent.high_level_integration_system import EmergencyStopLoss
...
def test_high_level_integration_system():
    ...
    try:
        ...
        from oanda_trading_bot.training_system.agent.meta_learning_optimizer import MetaLearningOptimizer        # Create required components
