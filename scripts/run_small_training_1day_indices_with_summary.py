#!/usr/bin/env python3
"""
1-day S5 short training including index CFDs with summary stats.

Run: python scripts/run_small_training_1day_indices_with_summary.py
"""
import os
import sys
...
def main():
    ...
    # Include index CFDs explicitly
    symbols = ["SPX500_USD", "AU200_AUD", "US2000_USD", "EUR_USD", "USD_JPY"]
    ...
    logger.info("=== Ensuring data for training (1-day window, indices included) ===")
    ...
    logger.info("=== Summary (indices run) ===")
